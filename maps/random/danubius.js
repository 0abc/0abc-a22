...
const oFemale = "units/gaul_support_female";
const oHealer = "units/gaul_support_healer";
const oSkirmisher = "units/gaul_citizen_javelin_infantry";
const oNakedFanatic = "units/gaul_champion_spear_infantry";
